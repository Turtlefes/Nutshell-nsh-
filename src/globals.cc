...
const char *const shell_version_long = "0.3.8.82";
...
const char *const LICENSE = "License GPLv3+: GNU GPL version 3 or later "
                            "<https://gnu.org/licenses/gpl.html>";
std::string shell_desc =
    "Nutshell (nsh) - Comes packed with features (and bugs). You get the "
    "standard UNIX tools, plus some... interesting additions you won't find "
    "anywhere else. Consider the bugs as bonus content.";
...
volatile pid_t foreground_pgid =
    0;                        // Sekarang digunakan untuk session management
