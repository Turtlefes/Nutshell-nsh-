...
// Struktur untuk menyimpan satu baris perintah lengkap, yang bisa berupa
// pipeline Dalam parser.h, tambahkan ke struct ParsedCommand
struct ParsedCommand {
  std::vector<SimpleCommand> pipeline;
  enum class Operator { NONE, AND, OR, SEQUENCE };
